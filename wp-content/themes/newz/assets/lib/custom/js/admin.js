(function ($) {
    ...
    var ajaxurl = newz_admin.ajax_url;
    var newzNonce = newz_admin.ajax_nonce;
    var custom_theme_file_frame;

    // Category Color
    $('#newz-cat-color').wpColorPicker();
    ...
    $('.twp-img-upload-button').click( function(){
        ...
        frame = wp.media({
            title: newz_admin.upload_image,
            button: {
            text: newz_admin.use_image
            },
    ...
    $('.twp-custom-setup').click(function(){
        ...
        var data = {
            'action': 'newz_notice_dismiss',
            '_wpnonce': newzNonce,
        };
 
        $.post(ajaxurl, data, function( response ) {

            $('.twp-newz-notice').hide();
    ...
    $('.twp-install-active').click(function(){
        ...
        $(this).closest('.twp-newz-notice').addClass('twp-installing');

        var data = {
            'action': 'newz_install_plugins',
            '_wpnonce': newzNonce,
        };
    ...
    $('.theme-recommended-plugin .recommended-plugin-status').click(function(){
        ...
        $.post(ajaxurl, data, function( response ) {
            ...
            var active = newz_admin.active
            var deactivate = newz_admin.deactivate
